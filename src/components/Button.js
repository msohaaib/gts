  ...
  return (
    <Link href={href} onClick={onClick} className={`group ${className}`}>
      <div className="relative overflow-hidden inline-block">
        <span
          className={`block transition-all duration-[1125ms] ease-out group-hover:-translate-y-7 ${
            isActive
              ? "text-[#F58634]"
        ...
        <span
          className={`absolute top-7 left-0 transition-all duration-[1125ms] ease-out group-hover:top-0 ${
            isActive
              ? "text-[#F58634]"
              : "text-gray-800 group-hover:text-[#F58634]"
          }`}
